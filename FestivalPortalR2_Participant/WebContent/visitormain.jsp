...
<body style="background-image: url(images/BackBack071.jpg); background-size:cover;">
		...
		<tr>
			...
			<table>
				<tr>
					...
					<table align="right" cellpadding="2">
						...
						<jstlcore:if test="${visitor.admin == '1' }">
                          <a href="<jstlcore:url value="/feedbackdisplay.htm"/>">Feedback </a>
							</jstlcore:if>
							<jstlcore:if test="${visitor.admin != '1'}">
							 <a href="<jstlcore:url value="/feedback.jsp?vid=${visitor.visitorId}&fname=${visitor.firstName}"/>"> Feedback </a>
							</jstlcore:if>
				...
				<tr>
					...
					<table cellpadding="5" width="100%">
						<tr>
							...
							<h3 class="id1">Festival Portal Page: Welcome <span style="background-color: yellow;"><jstlcore:out value="${visitor.firstName}"></jstlcore:out></span> to your portal page.....</h3>
							</div>							
							<table cellpadding="4">
								<tr>
									<td width="1000">
									...
									<a href="<jstlcore:url value="/updatevisitor.jsp?vid=${visitor.visitorId}&vname=${visitor.userName}&fname=${visitor.firstName}&lname=${visitor.lastName}&email=${visitor.email}&phoneno=${visitor.phoneNumber}&address=${visitor.address}"/>">click here </a></p>
									<p align="right"><a href="<jstlcore:url value="/accdelete.htm?vid=${visitor.visitorId}"/>">Delete Account Permanently</a></p>
									<p class="style1">First Name  : <jstlcore:out value="${visitor.firstName}"></jstlcore:out></p>
								 	<p class="style1">Last Name  :<jstlcore:out value="${visitor.lastName}"></jstlcore:out></p>
									...
									<p class="style1">Address  :<jstlcore:if test="${visitor.address!=''}">
									 
									 <jstlcore:out value="${visitor.address}"></jstlcore:out>
									</jstlcore:if>
									<jstlcore:if test="${visitor.address==null}">
									<jstlcore:out value="no address provided"></jstlcore:out></p>
									</jstlcore:if>
									</div>
									</td>
								</tr>
			...
			<table class="content" width="96%" border="1" align="center">
				<tr bgcolor="#66CC99">
					...
					<th scope="col">Description</th>
					<th scope="col">Places
					<a href="<jstlcore:url value="/displayplaceasc.htm"/>"><img src="images/upointer.jpg"/></a>
					<a href="<jstlcore:url value="/displayplacedesc.htm"/>"><img src="images/dpointer.jpg"/></a>
					</th>
					<th scope="col">Duration</th>
					<th scope="col">Event Type</th>
					<th scope="col">Event Session</th>
