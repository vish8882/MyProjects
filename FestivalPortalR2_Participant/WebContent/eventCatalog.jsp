...
<br/><br/><br/>
	<table width="80%" align="center">
		<tr>
			<td>
			<div id="header">&nbsp;
			<div align="center" style="color:#996666;  font-family: Algerian">Festival
			...
			<table>
				...
				<tr>
					...
					<h3 class="id1">Upcoming Events</h3>
				...
				<jstlcore:if test="${fn:length(allEvents) ge 1}">
				...
				<jstlcore:choose>
					  <jstlcore:when test="${event[6] != 0}">
						...
						<jstlcore:otherwise>
							<td width="100px" bgcolor="#CCCC99" align="center"><strong>
							Sold Out</strong></td>
						</jstlcore:otherwise>						
						</jstlcore:choose>
						<jstlcore:if test="${visitor.admin == true}">	
				...
				<jstlcore:if test="${regEvents}==0">
						<jstlcore:out value="There are currently no events upcoming.  Please check back later.  Thanks for visiting the event portal!">
						</jstlcore:out>
								</jstlcore:if>
