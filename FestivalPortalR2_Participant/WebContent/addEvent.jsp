				...
				<tr>
					...
					<table align="center" border="0">
						...
						<tbody><tr>
							...
							<h3 class="id1">New Event Registration Page</h3>
							</td>
						</tr>
					   ...
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Duration:</td><td><input type="text" name="duration" size="25" value="${event.duration}"></input></td>						   
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Event Type:</td><td><input type="text" name="eventType" size="25" value="${event.eventtype}"></input></td>						   
					   </tr>
					   <tr>
						   <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
