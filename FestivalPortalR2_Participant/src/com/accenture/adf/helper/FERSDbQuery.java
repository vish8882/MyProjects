...
public class FERSDbQuery {
	...
	private String searchEventPAsc = "";
	private String searchEventPDesc = "";
	private String deleteeventsignup = "";
	...
	public String getSearchEventPAsc() {
		return searchEventPAsc;
	}

	public void setSearchEventPAsc(String searchEventAsc) {
		this.searchEventPAsc = searchEventAsc;
	}

	public String getSearchEventPDesc() {
		return searchEventPDesc;
	}

	public void setSearchEventPDesc(String searchEventDesc) {
		this.searchEventPDesc = searchEventDesc;
	}
	...
	public String getDeletevisitor() {
		return deletevisitor;
	}

	public void setDeletevisitor(String deletevisitor) {
		this.deletevisitor = deletevisitor;
	}



	public void setDeleteeventsignup(String deleteeventsignup) {
		this.deleteeventsignup = deleteeventsignup;
	}

	public String getDeleteeventsignup() {
		// TODO Auto-generated method stub
		return deleteeventsignup;
	}
